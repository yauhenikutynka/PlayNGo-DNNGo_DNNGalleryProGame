    ...
    public class BaseModule : PortalModuleBase
    {
        ...
        public TabInfo Settings_TabInfo
        {
            get
            {
                ...
                {
                    _Settings_TabInfo = TabController.Instance.GetTab(Settings_TabID, Settings_PortalID); //new TabController().GetTab(Settings_TabID, Settings_PortalID, true);
                }
        ...
        {
            get { return Settings["DNNGalleryProGame_jQuery_Enable"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryProGame_jQuery_Enable"].ToString()) ? Convert.ToBoolean(Settings["DNNGalleryProGame_jQuery_Enable"]) : false; }
        }
        ...
        {
            get { return Settings["DNNGalleryProGame_jQuery_UseHosted"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryProGame_jQuery_UseHosted"].ToString()) ? Convert.ToBoolean(Settings["DNNGalleryProGame_jQuery_UseHosted"]) : false; }
        }
        ...
        {
            get { return Settings["DNNGalleryProGame_jQuery_HostedjQuery"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryProGame_jQuery_HostedjQuery"].ToString()) ? Convert.ToString(Settings["DNNGalleryProGame_jQuery_HostedjQuery"]) : "https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"; }
        }
        ...
        {
            get { return Settings["DNNGalleryProGame_jQuery_HostedjQueryUI"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryProGame_jQuery_HostedjQueryUI"].ToString()) ? Convert.ToString(Settings["DNNGalleryProGame_jQuery_HostedjQueryUI"]) : "https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js"; }
        }
        ...
        public void LoadManagerScript()
        {
            ...
            if ((objCSS != null))
            {
                ...
                if (HttpContext.Current.Items["DNNGo_DNNGalleryProGame_Modules_css"] == null)
                {
                    Literal litLink = new Literal();
                    litLink.Text = "<link  rel=\"stylesheet\" type=\"text/css\" href=\"" + ModulePath + "Resource/css/Modules.css\" />";

                    HttpContext.Current.Items.Add("DNNGo_DNNGalleryProGame_Modules_css", "true");
                    objCSS.Controls.Add(litLink);
                }
