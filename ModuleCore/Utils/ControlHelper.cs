...
namespace DNNGo.Modules.DNNGalleryProGame
{
    ...
    public class ControlHelper
    {
        ...
        public String ViewCreateDropDownListByGroup(SettingEntity FieldItem, String ControlName, String ControlID)
        {
            ...
            List<DNNGo_DNNGalleryProGame_Group> Groups = DNNGo_DNNGalleryProGame_Group.FindAllByModuleID(ModuleId);

            if (Groups != null && Groups.Count > 0)
            {
                foreach (DNNGo_DNNGalleryProGame_Group info in Groups)
                {
