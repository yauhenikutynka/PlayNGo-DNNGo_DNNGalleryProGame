...
namespace DNNGo.Modules.DNNGalleryProGame
{
    ...
    public class Common
    {
       ...
       /// <returns></returns>
        ...
        /// <param name="pagename"></param>
        /// <returns></returns>
        public static string FriendlySlug(string pagename)
        {
            if (!String.IsNullOrEmpty(pagename))
            {
                ...
                pagename = RemoveEscape(pagename);
                pagename = Pinyin.convertCh(pagename);
        ...
        /// <param name="realaceValue"></param>
        /// <returns></returns>
        public static String RemoveEscape(string realaceValue)
        {
            String ContentText = realaceValue;
            ContentText = ReplaceNoCase(ContentText, "&#39;", "");
            ContentText = ReplaceNoCase(ContentText, "&quot;", "");
            ContentText = ReplaceNoCase(ContentText, "&lt;", "");
            ContentText = ReplaceNoCase(ContentText, "&gt;", "");
            return ContentText;
