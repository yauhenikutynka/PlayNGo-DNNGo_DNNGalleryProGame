...
namespace DNNGo.Modules.DNNGalleryProGame
{
    ...
    /// <summary>多媒体</summary>
    public partial class DNNGo_DNNGalleryProGame_Files: Entity<DNNGo_DNNGalleryProGame_Files> 
    {
        #region 对象操作
        static DNNGo_DNNGalleryProGame_Files()
        {
            // 用于引发基类的静态构造函数，所有层次的泛型实体类都应该有一个
            DNNGo_DNNGalleryProGame_Files entity = new DNNGo_DNNGalleryProGame_Files();
        }
        ...
        public static DNNGo_DNNGalleryProGame_Files FindByID(Int32 id)
        {
            return Find(_.ID, id);
        }
