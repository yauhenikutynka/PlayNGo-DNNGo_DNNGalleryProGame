...
namespace DNNGo.Modules.DNNGalleryProGame
{
	...
	public partial class DNNGo_DNNGalleryProGame_FileLogs : Entity<DNNGo_DNNGalleryProGame_FileLogs>
	{
		...
		public static DNNGo_DNNGalleryProGame_FileLogs FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_DNNGalleryProGame_FileLogs entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_DNNGalleryProGame_FileLogs();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_DNNGalleryProGame_FileLogs FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_DNNGalleryProGame_FileLogs> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
