...
namespace DNNGo.Modules.DNNGalleryProGame
{
	...
	public partial class DNNGo_DNNGalleryProGame_Layer : Entity<DNNGo_DNNGalleryProGame_Layer>
	{
		...
		public static DNNGo_DNNGalleryProGame_Layer FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_DNNGalleryProGame_Layer entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_DNNGalleryProGame_Layer();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_DNNGalleryProGame_Layer FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
        ...
        /// <returns></returns>
        public static List<DNNGo_DNNGalleryProGame_Layer> FindAllBySliderID(Int32 SliderID)
        {
		...
		public static List<DNNGo_DNNGalleryProGame_Layer> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
