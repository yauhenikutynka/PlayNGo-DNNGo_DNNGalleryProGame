...
namespace DNNGo.Modules.DNNGalleryProGame
{
    public partial class Setting_ManagerGroup : BaseModule
    {
        ...
        private DNNGo_DNNGalleryProGame_Group _GroupItem;
        /// <summary>
        /// 分类项
        /// </summary>
        public DNNGo_DNNGalleryProGame_Group GroupItem
        {
            get
            {
                ...
                {
                    if (TagID > 0)
                        _GroupItem = DNNGo_DNNGalleryProGame_Group.FindByKeyForEdit(TagID);
                    else
                        _GroupItem = new DNNGo_DNNGalleryProGame_Group();
                }
                return _GroupItem;
            }
        }
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            Where.Add(new SearchParam(DNNGo_DNNGalleryProGame_Group._.ModuleId, ModuleId, SearchType.Equal));

            if (!String.IsNullOrEmpty(Search_Title))
            {
                txtSearch.Text = HttpUtility.UrlDecode(Search_Title);
                Where.Add(new SearchParam(DNNGo_DNNGalleryProGame_Group._.Name, HttpUtility.UrlDecode(Search_Title), SearchType.Like));
            }
        ...
        private void BindDataItem()
        {
            ...
            if (TagID > 0)
            {
                ...
                DNNGo_DNNGalleryProGame_Group item = DNNGo_DNNGalleryProGame_Group.FindByKeyForEdit(TagID);
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Sqp.ReturnFields = Sqp.Orderfld = DNNGo_DNNGalleryProGame_Group._.Sort;
                    Sqp.OrderType = 1;
                    Sqp.Where.Add(new SearchParam(DNNGo_DNNGalleryProGame_Group._.ModuleId, ModuleId, SearchType.Equal));
                    item.Sort = Convert.ToInt32(DNNGo_DNNGalleryProGame_Group.FindScalar(Sqp)) + 2;
        ...
        protected void gvArticleList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                //还原出数据
                DNNGo_DNNGalleryProGame_Group Categorie = e.Row.DataItem as DNNGo_DNNGalleryProGame_Group;
            ...
            try
            {
                ...
                if (Status >= 0)
                {
                    ...
                    for (int i = 0; i < Checkbox_Value_Array.Length; i++)
                    {
                        ...
                        {
                            DNNGo_DNNGalleryProGame_Group item = DNNGo_DNNGalleryProGame_Group.FindByKeyForEdit(IDX);
        ...
        protected void lbSort_Click(object sender, EventArgs e)
        {
            ...
            {
                //查出当前要排序的字段
                DNNGo_DNNGalleryProGame_Group objC = DNNGo_DNNGalleryProGame_Group.FindByKeyForEdit(ImgbutSort.CommandArgument);

                mTips.IsPostBack = true;//回发时就要触发
                if (ImgbutSort.ToolTip == "up")
                {
                    DNNGo_DNNGalleryProGame_Group.MoveField(objC, EnumMoveType.Up, ModuleId);
                    //字段上移成功
                ...
                {
                    DNNGo_DNNGalleryProGame_Group.MoveField(objC, EnumMoveType.Down, ModuleId);
                    //字段下移成功
