<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Library_Synchronize.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryProGame.Setting_Library_Synchronize" %>
