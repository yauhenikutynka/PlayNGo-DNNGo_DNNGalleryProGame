<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_Manager.aspx.cs" Inherits="DNNGo.Modules.DNNGalleryProGame.Index_Manager" %>
...
<div class="navbar navbar-inverse navbar-fixed-top"> 
  ...
  <div class="container">
    ...
    <div class="navbar-tools hidden-xs"> 
        ...
        <asp:HyperLink ID="hlDocumentation" resourcekey="hlDocumentation" runat="server" Target="_blank" CssClass="btn btn-teal" NavigateUrl="http://www.dnngo.net/doc/DNNGalleryProGame/index.html" Text="<i class='fa clip-book'></i> | Documentation" ToolTip="Documentation"></asp:HyperLink>
	...
	<!-- start: FOOTER -->
		<div class="footer clearfix">
			<div class="footer-inner">
				2013 &copy; DNNGalleryProGame by <a href="http://www.dnngo.net/" target="_blank">dnngo.net</a>.
			</div>
