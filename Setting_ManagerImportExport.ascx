<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_ManagerImportExport.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryProGame.Setting_ManagerImportExport" %>
