...
var mfpAnimation = function(){
	$(document).ready(function () {
	  $('.prolight_image').each(function () {
	    $(this).prolight({
	      type: 'image',
	      callbacks: {
	        beforeOpen: function () {
	  ...
	  $("[class^='prolight_image_gallery']").each(function () {
	    $("." + $(this).attr("class").split(" ")[0]).prolight({
	      type: 'image',
	      gallery: {
	        enabled: true,
	      ...
	      callbacks: {
	        ...
	        open: function () {
	          $.prolight.instance.next = function () {
	            var self = this;
	            self.wrap.removeClass('mfp-ready');
	            setTimeout(function () {
	              $.prolight.proto.next.call(self);
	            }, 120);
	          };
	          $.prolight.instance.prev = function () {
	            var self = this;
	            self.wrap.removeClass('mfp-ready');
	            setTimeout(function () {
	              $.prolight.proto.prev.call(self);
	            }, 120);
	          }
	        },
	  ...
	  $('.prolight_image_group').each(function (index, element) {
	    $(this).prolight({
	      delegate: 'a',
	      type: 'image',
	      tLoading: 'Loading ...',
	  ...
	  $('.prolight_youtube, .prolight_vimeo, .prolight_gmaps').prolight({
	    disableOn: 700,
	    type: 'iframe',
	    preloader: false,
	  ...
	  $("[class^='prolight_youtube_gallery'],[class^='prolight_vimeo_gallery'],[class^='prolight_gmaps_gallery']").each(function () {
	    $("." + $(this).attr("class").split(" ")[0]).prolight({
	      disableOn: 700,
	      type: 'iframe',
	      preloader: false,
	  ...
	  $('.prolight_youtube_group, .prolight_vimeo_group, .prolight_gmaps_group').each(function (index, element) {
	    $(this).prolight({
	      delegate: 'a',
	      disableOn: 700,
	      type: 'iframe',
	  ...
	  $(".prolight_ajax").each(function () {
	    $(".prolight_ajax").prolight({
	      type: 'ajax',
	      alignTop: true,
	      overflowY: 'scroll',
	      callbacks: {
	  ...
	  $("[class*='prolight_ajax_group']").each(function () {
	    $("." + $(this).attr("class").split(" ")[0]).prolight({
	      type: 'ajax',
	      alignTop: true,
	      overflowY: 'scroll',
