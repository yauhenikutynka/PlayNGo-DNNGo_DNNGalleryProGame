var UrlLibrary = function () {
    ...
    var BindDefaultPictureItem = function (urls_name, urls_div) {
        ...
        if (MediaID != null && MediaID != '') {
            ...
            $.getJSON(Module.ModulePath + "Resource_Service.aspx?Token=PictureItem&" + MediaID, { ModuleId: Module.ModuleId, TabId: Module.TabId, PortalId: Module.PortalId, PageIndex: 1, PageSize: 1 }, function (data) {
