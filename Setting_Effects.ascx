<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Effects.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryProGame.Setting_Effects" %>
...
<div class="row">
    <div class="col-sm-12">
                    ...
                    <div class="full_version_title" id="full_version_title" runat="server" visible="false">
                        ...
                        <br />
                        <%=ViewTitle("lblFullVersionContent", "If you need more effects,Please purchase the <a href='http://www.dnngo.net/DNNStore/tabid/58/CategoryID/105/List/0/Level/a/ProductID/468/Default.aspx' target='_blank'>DNNGo.DNNGalleryProGame</a> to own all amazing effects!")%>
                    </div>
