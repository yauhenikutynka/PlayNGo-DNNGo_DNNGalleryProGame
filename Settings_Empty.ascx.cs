...
namespace DNNGo.Modules.DNNGalleryProGame
{
    public partial class Settings_Empty : ModuleSettingsBase
    {
        ...
        private void BindModules()
        {
            ...
            DesktopModuleInfo objDesktopModuleInfo = DesktopModuleController.GetDesktopModuleByModuleName("DNNGo.DNNGalleryProGame",PortalId);
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if ((ddlModule.Items.Count > 0))
                {
                    ...
                    if (values.Length == 2)
                    {
                        objModuleController.UpdateModuleSetting(this.ModuleId, "DNNGalleryProGame_TabID", values[0]);
                        objModuleController.UpdateModuleSetting(this.ModuleId, "DNNGalleryProGame_ModuleID", values[1]);
                    }
                }
            }
            catch (Exception ex)
