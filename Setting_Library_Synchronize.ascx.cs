...
namespace DNNGo.Modules.DNNGalleryProGame
{
    public partial class Setting_Library_Synchronize : BaseModule
    {
        ...
        {
            String WebPath = String.Format("{0}DNNGalleryProGame/SynchronizeFiles/", PortalSettings.HomeDirectory);
        ...
        public void BindFileList(DirectoryInfo FolderPath)
        {
            ...
            if (SynchronizeFiles != null && SynchronizeFiles.Length > 0)
            {
                ...
                for (int i = 0; i < SynchronizeFiles.Length && i < 5; i++)
                {
                    ...
                    String FileWebPath = String.Format("DNNGalleryProGame/SynchronizeFiles/{0}", SynchronizeFile.Name);
